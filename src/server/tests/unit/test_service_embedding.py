...
class TestEmbeddingService:
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_success(self, embedding_service, mock_anthropic_client):
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_no_api_key(self, embedding_service_no_key):
    ...
    @pytest.mark.asyncio
    async def test_generate_embeddings_batch_success(self, embedding_service, mock_anthropic_client):
    ...
    @pytest.mark.asyncio
    async def test_generate_embeddings_batch_with_error(self, embedding_service, mock_anthropic_client):
    ...
    def test_truncate_text_short_text(self, embedding_service):
    ...
    def test_truncate_text_long_text(self, embedding_service):
    ...
    def test_truncate_text_with_sentence_boundary(self, embedding_service):
    ...
    def test_get_zero_vector(self, embedding_service):
    ...
    def test_is_available_with_api_key(self, embedding_service):
        """Test availability check with API key."""
        assert embedding_service.is_available() is True

    def test_is_available_without_api_key(self, embedding_service_no_key):
        """Test availability check without API key."""
        assert embedding_service_no_key.is_available() is False

    @pytest.mark.asyncio
    async def test_generate_embedding_api_error(self, embedding_service, mock_anthropic_client):
        """Test embedding generation with API error."""
        text = "This is a test document."
        
        # Mock API error
        mock_anthropic_client.embeddings.create.side_effect = Exception("API rate limit")

        with pytest.raises(Exception, match="API rate limit"):
            await embedding_service.generate_embedding(text)

    def test_token_estimation(self, embedding_service):
